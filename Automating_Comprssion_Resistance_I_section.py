...
class Auto_I_section:
    ...
    def __init__(self, Ned, L, grade, end_connections = 'Pinned-Pinned', E = 210000, beam_column = 'column', b_cw = 'c', b_cf ='c'):
        ...
        self.end_connections = end_connections # options: 'Pinned-Pinned', 'Fixed-Fixed', 'Pinned-Fixed', 'Fixed-Free' 
